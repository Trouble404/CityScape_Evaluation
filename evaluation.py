...
def pq_compute(gt_json_file, pred_json_file, gt_folder=None, pred_folder=None):
    ...
    pred_annotations = {el['file_name']: el for el in pred_json['annotations']}
    #print('pred_annotation:{}'.format(pred_annotations))
    matched_annotations_list = []
    for gt_ann in gt_json['annotations']:
        image_id = gt_ann['image_id']+'_leftImg8bit.png'
